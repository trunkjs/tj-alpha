...
describe('ContentBuilder arrangement based on example tj-content-area.html', () => {
    ...
    it('places nested headings (h3/h4) correctly underneath second <h2>', () => {
        ...
        const h3SecondSection = expectWrappedBySection(h3Second, 'section', '3.0');
        expect(h3SecondSection.parentElement).toBe(h2Section);
    });

    it.skip('creates dedicated sections for hr markers and handles + modifier (APPEND)', () => {
    ...
    it.skip('transfers section-* and layout-* attributes from heading to wrapper section', () => {
        const h1 = area.querySelector('h1') as HTMLElement;
    ...
    it.skip('moves additional attributes from <hr> markers to their wrapper section', () => {
